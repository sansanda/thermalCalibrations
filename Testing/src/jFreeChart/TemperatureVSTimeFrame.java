...
*/
public class TemperatureVSTimeFrame extends ApplicationFrame {
	/**
	 * 
	 */
	...
	*/
	...
	public TemperatureVSTimeFrame(String title, XYSeries serie) throws InterruptedException {
		super(title);
	...
	*/
	private static JFreeChart createChart(XYDataset dataset) {
		...
		domainAxis.setStandardTickUnits(DateAxis.createStandardDateTickUnits(TimeZone.getTimeZone("GMT+1:00")));
