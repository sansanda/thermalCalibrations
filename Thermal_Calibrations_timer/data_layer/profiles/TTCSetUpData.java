...
public class TTCSetUpData {
	...
	public String toString(){
		...
		res = res + ttcsToCalibrateData.toString();
		res = res + temperatureStabilizationCriteriumData.toString();
		res = res + ttcSetUpDescriptionData.toString();
		return res;
	}
	public static void main(String[] args) throws Exception{
		...
		temperatureStabilizationCriteriumData temperatureStabilizationCriteriumData = new temperatureStabilizationCriteriumData(5,0.0,0.03,120,1000,3,0,60);
