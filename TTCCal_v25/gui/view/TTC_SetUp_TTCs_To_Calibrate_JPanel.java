...
public class TTC_SetUp_TTCs_To_Calibrate_JPanel extends JPanel {
	 ...
	 * @throws Exception
	 */
	public TTC_SetUp_TTCs_To_Calibrate_JPanel(String _panelName, TemperatureSensorData 	_temperatureSensorData) throws Exception {
		super();
