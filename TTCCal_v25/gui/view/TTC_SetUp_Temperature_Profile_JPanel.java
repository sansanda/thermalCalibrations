...
public class TTC_SetUp_Temperature_Profile_JPanel extends JPanel implements ActionListener {
	 ...
	 */
	public TTC_SetUp_Temperature_Profile_JPanel(String _panelName) {
		super();
	...
	private void initialize(String _panelName) {
		...
		this.add(temperatureProfileConfigurationLabel, null);
	...
	public void loadTemperatureProfileData(TTCSetUpData _thermalCalibrationData){
		removeTemperatureProfileItemListeners();
