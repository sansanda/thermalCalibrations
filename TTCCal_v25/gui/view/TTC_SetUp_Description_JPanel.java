...
public class TTC_SetUp_Description_JPanel extends JPanel {
	 ...
	 */
	public TTC_SetUp_Description_JPanel(String _panelName,String _programName,String _programAuthor,String _programDescription) {
		super();
	 ...
	 * @return void
	 */
	private void initialize(String _panelName,String _programName,String _programAuthor,String _programDescription) {
		this.setBounds(new Rectangle(30, 180, 274, 185));
		...
		this.add(createProgramNameTextField(_programName), null);
	 ...
	 */
	private JTextField createProgramNameTextField(String _programName) {
		if (programNameTextField == null) {
			...
			programNameTextField.setText(_programName);
		}
	 ...
	 * @return javax.swing.JTextField
	 */
	private JTextField createProgramAuthorTextField(String _programAuthor) {
		if (programAuthorTextField == null) {
			...
			programNameTextField.setText(_programAuthor);
		}
	 ...
	 */
	private JTextArea createProgramDescriptionTextArea(String _programDescription) {
		if (programDescriptionTextArea == null) {
			...
			programDescriptionTextArea.setText(_programDescription);
		}
	...
	public void loadDescriptionData(TTCSetUpData _thermalCalibrationData){
	...
	public TTCSetUpDescriptionData getTTCSetUpDescriptionData() throws Exception{
		if (!this.validateDescriptionData()){
			return null;
		}
		return new TTCSetUpDescriptionData(this.programNameTextField.getText(),this.programAuthorTextField.getText(),this.programDescriptionTextArea.getText());  //  @jve:decl-index=0:
	}
	private boolean validateDescriptionData(){
