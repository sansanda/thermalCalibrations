...
public class TTC_SetUp_Stabilization_Criterium_JPanel extends JPanel {
	 ...
	 */
	public TTC_SetUp_Stabilization_Criterium_JPanel(String _panelName) {
		super();
	...
	public void loadTemperatureStabilizationCriteriumData(TTCSetUpData _thermalCalibrationData){
	...
	private boolean validateTemperatureStabilizationCriteriumData(){
		return true;
	}
