...
public class DiodeToCalibrate_Data {
	private boolean selected;
	private String deviceReference;
	private int deviceChannel;

	public DiodeToCalibrate_Data(Element _deviceDataElement)throws Exception{
		initializeFromElement(_deviceDataElement);
	}
	public DiodeToCalibrate_Data(boolean _selected,String _deviceReference,int _deviceChannel)throws Exception{
		selected = _selected;
