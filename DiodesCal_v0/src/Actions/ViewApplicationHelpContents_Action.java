...
import gui.HelpContents_Frame;

public class ViewApplicationHelpContents_Action implements Action{
	private ActionResult result;
	private MainController main;
	private JFrame frameWhoHasTheRequest;
	private HelpContents_Frame helpContentsFrame;
	...
	{
		helpContentsFrame = new HelpContents_Frame(main);
