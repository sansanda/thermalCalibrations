...
public class EditExistingCalibrationProgramAction implements Action{
	...
	public EditExistingCalibrationProgramAction(){
		result=null;
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
    		...
    		ttcProgramViewer = new ThermalCalibrationProgramViewerFrame(_program,2,mainController);
