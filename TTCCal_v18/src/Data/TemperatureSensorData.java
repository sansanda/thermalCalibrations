...
public class TemperatureSensorData {
	...
	public TemperatureSensorData(String _filePath,String _type, int _channel)throws Exception{
		filePath = _filePath;
		type = _type; 
		channel = _channel;
	}
	...
	public Element convertToJDOMElement(String _name){
			...
			temperatureSensorDataElement.setAttribute("FilePath", filePath);
	...
	public void initializeFromElement(Element _temperatureSensorDataDataElement) throws Exception{
		filePath = _temperatureSensorDataDataElement.getAttributeValue("FilePath");
	...
	public static void main(String[] args) throws Exception{
		...
		TemperatureSensorData temperatureSensorData = new TemperatureSensorData(temperatureSensorDataFilePath, "PT100", 4);
		temperatureSensorData.toXMLFile("InstrumentsData");
