...
public class InstrumentsData {
	...
	public InstrumentsData(String _filePath, InstrumentData _multimeterData,InstrumentData _ovenData)throws Exception{
		filePath = _filePath;
	...
	public Element convertToJDOMElement(String _name){
			...
			instrumentsDataElement.setAttribute("FilePath", filePath);
	...
	public void initializeFromElement(Element _instrumentsDataElement) throws Exception{
		...
		filePath = 	_instrumentsDataElement.getAttributeValue("FilePath");
	}
	/**
	 * Title: toXMLFile
	 * Description: Método que convierte una instancia de la classe InstrumentsData
	...
	public static void main(String[] args) throws Exception{
		...
		InstrumentsData instrumentsData = new InstrumentsData(instrumentsDataFilePath, _2404Data, _2700Data);
		instrumentsData.toXMLFile("InstrumentsData");
