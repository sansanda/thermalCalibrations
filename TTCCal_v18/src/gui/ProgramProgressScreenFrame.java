...
public class ProgramProgressScreenFrame extends JFrame{
	...
	private org.jfree.data.time.TimeSeries realOvenTempSerie = null;
	...
	private Dimension chartPaneDimension = new Dimension((int)(frameDimension.getWidth()-100), (int)(frameDimension.getHeight()-100));


	/**
	 * This is the default constructor
	 */
	public ProgramProgressScreenFrame(MainController _mainController) {
		super();
	...
	private JPanel getProgressPanel() {
		if (progressPanel == null) {
			...
			progressPanel.setBounds(new Rectangle(1, 739, 991, 33));
	...
	private JTabbedPane getLogResultsTableAndGraphTabbedPane() {
		if (logResultsTableAndGraphTabbedPane == null) {
			...
			logResultsTableAndGraphTabbedPane.setBounds(new Rectangle(0, 0, 990, 740));
    ...
    public int initializeResultsTable(ThermalCalibrationProgramData _program,TemperatureSensorData _temperatureSensorData){
