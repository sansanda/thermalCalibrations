...
public class TTCCalibrationViewerFrame extends JFrame implements ActionListener{
	...
	private ItemListener 	ttc6MultimeterChannelComboBoxItemListener = null;
	...
	private void loadTemperatureProfileProgramData(TTCSetUpData _thermalCalibrationData){
		...
		this.maxTempTextField.setText(String.valueOf(_thermalCalibrationData.getTemperatureProfileData().getTemperatures()[_thermalCalibrationData.getTemperatureProfileData().getTemperatures().length-1]));
		this.minTempComboBox.setSelectedItem(String.valueOf(_thermalCalibrationData.getTemperatureProfileData().getTemperatures()[0]));
		this.nStepsComboBox.setSelectedItem(String.valueOf(_thermalCalibrationData.getTemperatureProfileData().getTemperatures().length));
