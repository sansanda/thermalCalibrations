...
public class RunTTCalibrationSetUpAction implements Action{
		...
		runProgramSwingWorker = new SwingWorker() {
			public Object construct() {
				try {
					...
					determineStableRoomTemperature(
					...
					//Measure devices at stable room temperature and save data
	...
	private void determineStableRoomTemperature(final int _desiredNWindowsUnderStDev,final double _desiredStDev,final int _nSamples, final long _delayBetweenSamplesInMilliseconds, final TTCSetUpData _ttcSetUpData,final TemperatureSensorData _temperatureSensorData) throws Exception
	{
