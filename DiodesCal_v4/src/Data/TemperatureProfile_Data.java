...
public class TemperatureProfile_Data {
	private String temperatureProfileName;
	private boolean waitForGoodRoomTemperatureStabilization;
	private int[] temperatures;

	public TemperatureProfile_Data(Element _temperatureProfileDataElement)throws Exception{
		initializeFromElement(_temperatureProfileDataElement);
	}
	public TemperatureProfile_Data(String _temperatureProfileName, boolean _waitForGoodRoomTemperatureStabilization, int[] _temperatures){
