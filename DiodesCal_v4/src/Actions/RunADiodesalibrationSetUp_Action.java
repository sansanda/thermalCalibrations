...
public class RunADiodesalibrationSetUp_Action implements Action{
    ...
    private void waitForRoomTemperatureStabilization(double _desiredStDev, int _desiredNWindowsUnderStDev,int _measurementWindow, long _samplingPeriodeInMilliseconds, DiodesCalibrationSetUp_Data _diodeCalibrationSetUpData,TemperatureSensor_Data _temperatureSensorData) throws Exception{
        ...
        pt100RealT = K2700.measurePT100Temperature(_temperatureSensorData.getChannel()).getValue();
    ...
    private double read2700ChannelsAndSaveDataToFile(DiodesCalibrationSetUp_Data _diodesCalibrationSetUp_Data,TemperatureSensor_Data _temperatureSensorData) throws Exception{
        double pt100RealT = 0;
        ...
        for (int i=0;i<_diodesCalibrationSetUp_Data.getDiodesToCalibrateData().getNDevicesToMeasure();i++){
            ...
            resultRow[i+1] = Double.toString(K2700.measureAverageDCVoltage(diodesCalibrationSetUp.getDiodesToCalibrateData().getDiodesToMeasureData()[i].getDeviceChannel(),avg).getValue());
        }
