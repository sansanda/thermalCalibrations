...
import uoc.ei.tads.sequencies.LlistaAfOrdenada;
import uoc.ei.tads.sequencies.LlistaAfOrdenadaSeq;
...
public class TTCCalibrationViewerFrame extends JFrame implements ActionListener{
	...
	private static final double MAX_ADMISSIBLE_TEMP_ERROR_MIN_VALUE = 0.10;
	private static final double MAX_ADMISSIBLE_TEMP_ERROR_INCREMENT = 0.10;
	...
	private ItemListener 	stepValueComboBoxItemListener = null;
	...
	private JPanel getTemperatureStabilizationCriteriumDataPanel() {
		if (temperatureStabilizationCriteriumDataPanel == null) {
			...
			maxAdmissibleTempErrorLabel1.setBounds(new Rectangle(390, 375, 151, 31));
			...
			maxAdmissibleTempErrorLabel.setBounds(new Rectangle(30, 375, 226, 31));
			...
			maxAdmissibleTempErrorLabel.setText("Max Admissible Temp Error");
	...
	private void saveToXMLFile(String _programFilePath) throws Exception{
		  ...
		  temperatureStabilizationCriteriumData temperatureStabilizationCriteriumProgramData = new temperatureStabilizationCriteriumData(0,Double.parseDouble((String)this.stDevComboBox.getSelectedItem()),Integer.parseInt((String)this.measurementWindowComboBox.getSelectedItem()),Long.parseLong((String)this.samplingPeriodeTextField.getText()),Integer.parseInt((String)this.numberOfSuccessiveWindowsUnderStDevComboBox.getSelectedItem()),temperatureStabilitzationMethod, Integer.parseInt((String)this.temperatureStabilitzationTimeComboBox.getSelectedItem()));
	...
	private JComboBox getMaximunAdmissibleTempErrorComboBox() {
		if (maxAdmissibleTempErrorComboBox == null) {
			...
			maxAdmissibleTempErrorComboBox.setBounds(new Rectangle(270, 375, 106, 31));
			for (double i=MAX_ADMISSIBLE_TEMP_ERROR_MIN_VALUE;i<=MAX_ADMISSIBLE_TEMP_ERROR_MAX_VALUE;i=i+MAX_ADMISSIBLE_TEMP_ERROR_INCREMENT){
				maxAdmissibleTempErrorComboBox.addItem (Double.toString(i));
			}
		}
	...
	private JComboBox getStandardDeviationComboBox() {
		if (stDevComboBox == null) {
			...
			stDevComboBox.setBounds(new Rectangle(345, 120, 106, 31));
