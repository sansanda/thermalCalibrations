...
public class Eurotherm2404_v3 {
	 ...
	 * @throws Exception
	 */
	public Eurotherm2404_v3(String wantedPortName,int _controllerID) throws Exception {
	 ...
	 * @throws Exception
	 */
	private void initializeModbusMaster(SerialParameters sp) throws Exception {
		modbusSerialMaster = new ModbusSerialMaster(sp);
		modbusSerialMaster.setUnitIdentifier(CONTROLLER_ID);
	...
	public int readTemperature() throws Exception{
		int result = -500;
		initializeSerialConnection(sp);
	...
	public static void main(String[] args) {
		try {
			...
			Eurotherm2404_v3 eurotherm2404 = new Eurotherm2404_v3("COM4",1);
