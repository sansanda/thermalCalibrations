...
public class ViewExistingDiodesCalibrationProgram_Action implements Action{
	...
	private DiodesCalibrationViewerFrame diodesCalibrationSetUpViewer;
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
    		...
    		DiodesCalibrationSetUpData _program = new DiodesCalibrationSetUpData(programFilePath);
    		System.out.println(_program.toString());

    		diodesCalibrationSetUpViewer = new DiodesCalibrationViewerFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,diodesCalibrationSetUpFilePath,_program,viewMode,mainController);
    		diodesCalibrationSetUpViewer.addWindowListener(mainController);
    		diodesCalibrationSetUpViewer.setVisible(true);
    		diodesCalibrationSetUpViewer.loadThermalCalibrationData(_program);
    		return true;
        } else {
