...
public class DiodeToCalibrateData {
	private boolean selected;
	private String deviceReference;
	private int deviceChannel;

	public DiodeToCalibrateData(Element _deviceDataElement)throws Exception{
		initializeFromElement(_deviceDataElement);
	}
	public DiodeToCalibrateData(boolean _selected,String _deviceReference,int _deviceChannel)throws Exception{
		selected = _selected;
