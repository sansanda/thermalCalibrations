...
public class TTCSetUpDescriptionData {
	private String programName;
	private String programAuthor;
	private String programDescription;

	public TTCSetUpDescriptionData(Element _generalProgramDataElement) throws Exception{
		initializeFromElement(_generalProgramDataElement);
	}
	public TTCSetUpDescriptionData(String _programName, String _programAuthor,String _programDescription)throws Exception{
