...
public class TTCsCalibration_ProgressScreenFrame extends JFrame{
	 ...
	 */
	public TTCsCalibration_ProgressScreenFrame(TTC_Calibration_MainController _mainController) {
		super();
