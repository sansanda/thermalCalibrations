...
public class DiodesCalibration_ProgressScreenFrame extends JFrame{

	private static final long serialVersionUID = 1L;
	private static String 	MADRID_TIME_ZONE = "GMT+1";

	private TTC_Calibration_MainController mainController = null;  //  @jve:decl-index=0:
	 ...
	 */
	public DiodesCalibration_ProgressScreenFrame(TTC_Calibration_MainController _mainController) {
		super();
