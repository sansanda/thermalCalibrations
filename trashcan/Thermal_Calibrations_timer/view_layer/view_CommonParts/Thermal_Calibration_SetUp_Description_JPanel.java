...
public class Thermal_Calibration_SetUp_Description_JPanel extends JPanel {
	 ...
	 */
	public Thermal_Calibration_SetUp_Description_JPanel(
			String _panelName,
			String _programName,
	...
	public void loadDescriptionData(TTCSetUpDescriptionData _TTCSetUpDescriptionData){
		this.programNameTextField.setText((String)_TTCSetUpDescriptionData.getProgramName());
		this.programAuthorTextField.setText((String)_TTCSetUpDescriptionData.getProgramAuthor());
		this.programDescriptionTextArea.setText((String)_TTCSetUpDescriptionData.getProgramDescription());
	}
