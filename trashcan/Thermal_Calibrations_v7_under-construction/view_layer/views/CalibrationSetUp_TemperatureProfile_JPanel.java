...
import calibrationSetUp.CalibrationSetUp_TemperatureProfile;


public class CalibrationSetUp_TemperatureProfile_JPanel extends JPanel implements ActionListener {
	 ...
	 */
	public CalibrationSetUp_TemperatureProfile_JPanel(String _panelName) {
		super();
	...
	public void loadTemperatureProfileData(CalibrationSetUp_TemperatureProfile _temperatureProfileData){
		removeTemperatureProfileItemListeners();
	...
	public CalibrationSetUp_TemperatureProfile getTemperatureProfileData() throws NumberFormatException, Exception{
		...
		return new CalibrationSetUp_TemperatureProfile("TemperatureProfileData_1",temperatures);
	}
