...
public class CalibrationSetUp_TemperatureProfile {
	private String temperatureProfileName;
	private int[] temperatures;

	public CalibrationSetUp_TemperatureProfile(Element _temperatureProfileDataElement)throws Exception{
		initializeFromElement(_temperatureProfileDataElement);
	}
	public CalibrationSetUp_TemperatureProfile(String _temperatureProfileName, int[] _temperatures){
	...
	public String toString(){
		String res="";
		res = res + "TEMPERATURE PROFILE"+ "\n";
		res = res + " Temperature Profile Name = " + temperatureProfileName + "\n";
		res = res + " Temperatures = ";
		for (int i=0;i<temperatures.length;i++){
			res = res + temperatures[i] + "-";
		}
		res = res + "\n";
		return res;
	}
