...
public class CalibrationSetUp_TemperatureStabilizationCriteria {
	...
	public CalibrationSetUp_TemperatureStabilizationCriteria(Element _generalProgramDataElement) throws Exception{
		initializeFromElement(_generalProgramDataElement);
	}
	public CalibrationSetUp_TemperatureStabilizationCriteria
	...
	public String toString(){
		String res="";
		res = res + "TEMPERATURE STABILIZATION CRITERIA" + "\n";
