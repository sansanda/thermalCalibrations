...
public class TemperatureSensor {
	private String 	type;
	private int 	channel;
	public TemperatureSensor(Element _temperatureSensorDataDataElement)throws Exception{
		this.initializeFromElement(_temperatureSensorDataDataElement);
	}
	public TemperatureSensor(String _type, int _channel)throws Exception{
		type = _type;
		channel = _channel;
	}
	public TemperatureSensor(String _filePath)throws Exception{
	 ...
	 * @param 	TemperatureSensor _temperatureSensor con la instancia de classe TemperatureSensor
	 * @return Element
	 * @throws Exception
	 */
	...
	public static void main(String[] args) throws Exception{
		...
		TemperatureSensor temperatureSensorData = new TemperatureSensor("PT100", 4);
		temperatureSensorData.toXMLFile("InstrumentsData",temperatureSensorDataFilePath);
		TemperatureSensor temperatureSensorData2 = new TemperatureSensor(temperatureSensorDataFilePath);
