...
public class OvenMeasuresCluster {
	...
	public String toString() {
		String res = "";
		res = res + "Desired Oven Temperature = " +  	ovenDesiredTemperature.toString();
		res = res + "Oven Temperature = " +  			ovenTemperatureMeasure.toString();
		res = res + "Pt100 Temperature = " +  			ovenPt100TemperatureMeasure.toString();
		res = res + "Pt100 Resistance = " +  			ovenPt100ResistanceMeasure.toString();
		res = res + "Temperature Error (%) = " +  		ovenTemperatureErrorInPercent;
		res = res + "Output Power (%) = " +  			ovenOutputPowerInPercent;
		return res;
	}
