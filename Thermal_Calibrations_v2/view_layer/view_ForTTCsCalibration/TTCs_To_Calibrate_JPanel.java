...
public class TTCs_To_Calibrate_JPanel extends JPanel {
	...
	private static final int 	X_ORIGIN = 135;
	private static final int 	TTC_LABEL_WIDTH = 61;
	//Variables
	...
	private ItemListener 	ttc5MultimeterChannelComboBoxItemListener = null;  //  @jve:decl-index=0:
	 ...
	 * @throws Exception
	 */
	public TTCs_To_Calibrate_JPanel(String _panelName, TemperatureSensorData 	_temperatureSensorData) throws Exception {
		super();
	...
	private void initialize(String _panelName,TemperatureSensorData _temperatureSensorData) throws Exception {
		...
		this.add(getTTCsToCalibrateConfigurationLabel());
		this.add(getTTCMultimeterChannelLabel(), null);
		this.add(getTTCRefLabel(), null);
		this.add(getWarningTextField(), null);
		this.add(getTemperatureSensorChannelIndicatorTextField(), null);

		this.add(getTTC1Label(), null);
		this.add(getTTC2Label(), null);
		this.add(getTTC3Label(), null);
		this.add(getTTC4Label(), null);
		this.add(getTTC5Label(), null);
		this.add(getTTC6Label(), null);
		this.add(getTTC7Label(), null);
	...
	private JLabel getTTC1Label(){
		if (ttc1Label==null){
			ttc1Label = new JLabel();
			ttc1Label.setText("TTC1");
			ttc1Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc1Label.setBounds(new Rectangle(X_ORIGIN, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc1Label;
	}
	private JLabel getTTC2Label(){
		if (ttc2Label==null){
			ttc2Label = new JLabel();
			ttc2Label.setText("TTC2");
			ttc2Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc2Label.setBounds(new Rectangle(X_ORIGIN+TTC_LABEL_WIDTH, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc2Label;
	}
	private JLabel getTTC3Label(){
		if (ttc3Label==null){
			ttc3Label = new JLabel();
			ttc3Label.setText("TTC3");
			ttc3Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc3Label.setBounds(new Rectangle(X_ORIGIN+2*TTC_LABEL_WIDTH, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc3Label;
	}
	private JLabel getTTC4Label(){
		if (ttc4Label==null){
			ttc4Label = new JLabel();
			ttc4Label.setText("TTC4");
			ttc4Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc4Label.setBounds(new Rectangle(X_ORIGIN+3*TTC_LABEL_WIDTH, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc4Label;
	}
	private JLabel getTTC5Label(){
		if (ttc5Label==null){
			ttc5Label = new JLabel();
			ttc5Label.setText("TTC5");
			ttc5Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc5Label.setBounds(new Rectangle(X_ORIGIN+4*TTC_LABEL_WIDTH, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc5Label;
	}
	private JLabel getTTC6Label(){
		if (ttc6Label==null){
			ttc6Label = new JLabel();
			ttc6Label.setText("TTC6");
			ttc6Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc6Label.setBounds(new Rectangle(X_ORIGIN+5*TTC_LABEL_WIDTH, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc6Label;
	}
	private JLabel getTTC7Label(){
		if (ttc7Label==null){
			ttc7Label = new JLabel();
			ttc7Label.setText("TTC7");
			ttc7Label.setHorizontalAlignment(SwingConstants.CENTER);
			ttc7Label.setBounds(new Rectangle(X_ORIGIN+6*TTC_LABEL_WIDTH, 120, TTC_LABEL_WIDTH, 16));
		}
		return ttc7Label;
	}


	private JLabel getTTCRefLabel(){
		if (ttcRefLabel==null){
	...
	private JLabel getTTCMultimeterChannelLabel(){
		if (ttcMultimeterChannelLabel==null){
		...
		return ttcMultimeterChannelLabel;
	}
	private JLabel getTTCsToCalibrateConfigurationLabel(){
		if (ttcsToCalibrateConfigurationLabel==null){
		...
		return ttcsToCalibrateConfigurationLabel;
	}
	/**
	...
	private void setDefaultTTCsToCalibrateData(){
		...
		this.ttc1MultimeterChannelComboBox.setSelectedItem("1");
		this.ttc2CheckBox.setSelected(false);
		this.ttc2RefTextField.setText("TTC_2");
		this.ttc2MultimeterChannelComboBox.setSelectedItem("2");
		this.ttc3CheckBox.setSelected(false);
		this.ttc3RefTextField.setText("TTC_3");
		this.ttc3MultimeterChannelComboBox.setSelectedItem("3");
		this.ttc4CheckBox.setSelected(false);
		this.ttc4RefTextField.setText("TTC_4");
		this.ttc4MultimeterChannelComboBox.setSelectedItem("4");
		this.ttc5CheckBox.setSelected(false);
		this.ttc5RefTextField.setText("TTC_5");
		this.ttc5MultimeterChannelComboBox.setSelectedItem("5");
		this.ttc6CheckBox.setSelected(false);
		this.ttc6RefTextField.setText("TTC_6");
		this.ttc6MultimeterChannelComboBox.setSelectedItem("6");
		this.ttc7CheckBox.setSelected(false);
		this.ttc7RefTextField.setText("TTC_7");
		this.ttc7MultimeterChannelComboBox.setSelectedItem("7");
	}
	public void loadTTCsToCalibrateData(TTCsToCalibrateData _TTCsToCalibrateData){

		this.ttc1CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[0].isSelected());
		this.ttc1RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[0].getDeviceReference());
		this.ttc1MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[0].getDeviceChannel());

		this.ttc2CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[1].isSelected());
		this.ttc2RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[1].getDeviceReference());
		this.ttc2MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[1].getDeviceChannel());

		this.ttc3CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[2].isSelected());
		this.ttc3RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[2].getDeviceReference());
		this.ttc3MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[2].getDeviceChannel());

		this.ttc4CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[3].isSelected());
		this.ttc4RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[3].getDeviceReference());
		this.ttc4MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[3].getDeviceChannel());

		this.ttc5CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[4].isSelected());
		this.ttc5RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[4].getDeviceReference());
		this.ttc5MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[4].getDeviceChannel());

		this.ttc6CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[5].isSelected());
		this.ttc6RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[5].getDeviceReference());
		this.ttc6MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[5].getDeviceChannel());

		this.ttc7CheckBox.setSelected(_TTCsToCalibrateData.getDevicesToMeasureData()[6].isSelected());
		this.ttc7RefTextField.setText(_TTCsToCalibrateData.getDevicesToMeasureData()[6].getDeviceReference());
		this.ttc7MultimeterChannelComboBox.setSelectedItem(_TTCsToCalibrateData.getDevicesToMeasureData()[6].getDeviceChannel());
