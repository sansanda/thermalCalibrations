...
public class Configuration_Action implements Action {

	private ActionResult result = null;
	private MainController mainController = null;
	private Configuration_Frame configuration_Frame = null;
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception {
		configuration_Frame = new Configuration_Frame(instrumentsDataFilePath,temperatureSensorDataFilePath,mainController);
