...
public class MainScreenFrame extends JFrame implements ActionListener{
	...
	public ProgressScreenPanel2 progressScreenPane;
	...
	**/
	...
	public void createProgressScreenPane(ThermalCalibrationProgramData _program, int _nTableRows, int _nTableColumns){
		progressScreenPane = new ProgressScreenPanel2(this,_program,_nTableRows,_nTableColumns,new Dimension(500,500));
		progressScreenPane.setVisible(true);
		setVisible(true);
	}
}
