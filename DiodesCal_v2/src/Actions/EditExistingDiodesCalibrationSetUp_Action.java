...
public class EditExistingDiodesCalibrationSetUp_Action implements Action{
	...
	private DiodesCalibrationViewer_Frame diodeCalibrationSetUpViewer;
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
    		...
    		DiodesCalibrationSetUp_Data _diodesCalibrationSetUpData = new DiodesCalibrationSetUp_Data(diodeCalibrationSetUpFilePath);
    		System.out.println(_diodesCalibrationSetUpData.toString());

    		diodeCalibrationSetUpViewer = new DiodesCalibrationViewer_Frame(instrumentsDataFilePath,temperatureSensorDataFilePath,diodeCalibrationSetUpFilePath,_diodesCalibrationSetUpData,editMode,mainController);
    		diodeCalibrationSetUpViewer.addWindowListener(mainController);
    		diodeCalibrationSetUpViewer.loadDiodesCalibrationSetUpData(_diodesCalibrationSetUpData);
