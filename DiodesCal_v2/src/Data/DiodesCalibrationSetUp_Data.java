...
public class DiodesCalibrationSetUp_Data {
	...
	private DiodesCalibrationSetUpDescription_Data 		diodesSetUpDescriptionData;
	...
	public void initializeFromXMLFile(String _filePath)throws Exception{
		...
		diodesSetUpDescriptionData = new DiodesCalibrationSetUpDescription_Data(thermalCalibrationProgramElementRoot.getChild("TTCSetUpDescriptionData"));
