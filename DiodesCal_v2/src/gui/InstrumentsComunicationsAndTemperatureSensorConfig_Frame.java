...
public class InstrumentsComunicationsAndTemperatureSensorConfig_Frame extends JFrame implements ActionListener{
	...
	private Instruments_Data instrumentsData = null;  //  @jve:decl-index=0:
...
/**
	 ...
	 */
	public InstrumentsComunicationsAndTemperatureSensorConfig_Frame(String _instrumentsDataFilePath,String _temperatureSensorDataFilePath,MainController _mainController)throws Exception {
	...
	private void initialize(String _instrumentsDataFilePath,String _temperatureSensorDataFilePath) throws Exception {
		...
		this.instrumentsData = new Instruments_Data(_instrumentsDataFilePath);
		this.temperatureSensorData = new TemperatureSensor_Data(_temperatureSensorDataFilePath);
	...
	private void loadInstrumentsData(Instruments_Data _instrumentsData){
	...
	private void loadTemperatureSensorData(TemperatureSensor_Data _temperatureSensorData){
	...
	public void actionPerformed (ActionEvent event) {
		  ...
		  if (cmd.equals("Save")) {
			  ...
			  try {
				  Instruments_Data i = new Instruments_Data(
						  new Instrument_Data("","",0,(String)this.multimeterSerialPortComboBox.getSelectedItem()),
						  new Instrument_Data("","",Integer.valueOf((String)this.ovenControllerIDComboBox.getSelectedItem()),(String)this.ovenSerialPortComboBox.getSelectedItem())
				  );
				  this.instrumentsData = i;
				  this.instrumentsData.toXMLFile("InstrumentsData", "ConfigurationFiles\\instrumentsData.xml");
				  TemperatureSensor_Data t = new TemperatureSensor_Data(
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				InstrumentsComunicationsAndTemperatureSensorConfig_Frame thisClass;
				try {
					thisClass = new InstrumentsComunicationsAndTemperatureSensorConfig_Frame(instrumentsDataFilePath,temperatureSensorDataFilePath,null);
