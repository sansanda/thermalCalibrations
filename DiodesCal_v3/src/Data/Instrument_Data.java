...
public class Instrument_Data {
	...
	public Instrument_Data(Element _instrumentDataElement)throws Exception{
		initializeFromElement(_instrumentDataElement);
	}
	public Instrument_Data(String _model,String _manufacturer,int _controllerID,String _comPort)throws Exception{
		model = _model;
