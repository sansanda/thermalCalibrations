...
public class ThermalCalibrationProgramViewerFrame extends JFrame implements ActionListener{
	...
	private static final int N_MEASURES_PER_CLICLE_MIN_VALUE = 60;
	private static final int N_MEASURES_PER_CLICLE_MAX_VALUE = 240;
	private static final int N_MEASURES_PER_CLICLE_INCREMENT = 1;
	private static final long TIME_BETWEEN_SUCCESIVES_MEASURES_MIN_VALUE_MILLISECONDS = 500;
	...
	private void loadMeasuresConfigurationProgramData(ThermalCalibrationProgramData _program){
		...
		this.dev1MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[0].getDeviceChannel());
		...
		this.dev2MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[1].getDeviceChannel());
		...
		this.dev3MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[2].getDeviceChannel());
		...
		this.dev4MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[3].getDeviceChannel());
		...
		this.dev5MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[4].getDeviceChannel());
		...
		this.dev6MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[5].getDeviceChannel());
		...
		this.dev7MultimeterChannelComboBox.setSelectedItem(_program.getMeasuresConfigurationData().getDevicesToMeasureData()[6].getDeviceChannel());
