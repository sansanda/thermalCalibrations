...
public class CalibrationSetUp_ProgressScreen_JFrame extends JFrame{
	...
	private Calibration_MainController mainController = null;  //  @jve:decl-index=0:
	 ...
	 */
	public CalibrationSetUp_ProgressScreen_JFrame(Calibration_MainController _mainController) {
		super();
