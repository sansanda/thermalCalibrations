...
import view.TTCsCalibrationViewerFrame;
...
public class EditExistingTTCalibrationSetUpAction implements Action{
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
    		...
    		ttcProgramViewer = new TTCsCalibrationViewerFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,ttcSetUpFilePath,_program,EDIT_MODE,mainController);
