...
import data.DataInterface.InstrumentData;
import data.DataInterface.InstrumentsData;
import data.DataInterface.TTCSetUpData;
import data.DataInterface.TTCSetUpDescriptionData;
import data.DataInterface.TTCToCalibrateData;
import data.DataInterface.TTCsToCalibrateData;
import data.DataInterface.TemperatureProfileData;
import data.DataInterface.TemperatureSensorData;
import data.DataInterface.temperatureStabilizationCriteriumData;
...
public class TTCCalibrationViewerFrame extends JFrame implements ActionListener{
	...
	private static final double MAX_ADMISSIBLE_TEMP_ERROR_MAX_VALUE = 5.00;
	private static final double MAX_ADMISSIBLE_TEMP_ERROR_MIN_VALUE = 0.01;
	private static final double MAX_ADMISSIBLE_TEMP_ERROR_INCREMENT = 0.01;
	...
	private JLabel 		maxAdmissibleTempErrorLabel = null;
	...
	private JComboBox 		maxAdmissibleTempErrorComboBox = null;
	...
	private ItemListener 	nStepsComboBoxItemListener = null;
	...
	private ItemListener 	temperatureStabilitzationByStDevjRadioButtonItemListener = null;
	private ItemListener 	ttc1MultimeterChannelComboBoxItemListener = null;
	private ItemListener 	ttc2MultimeterChannelComboBoxItemListener = null;
	private ItemListener 	ttc3MultimeterChannelComboBoxItemListener = null;
	private ItemListener 	ttc4MultimeterChannelComboBoxItemListener = null;
	...
	private JLabel 			maxAdmissibleTempErrorLabel1 = null;
	...
	private JPanel getTTCSToCalibratePanel() throws Exception{
		if (ttcsToCalibratePanel == null) {
			...
			ttcsToCalibrateConfigurationLabel.setBounds(new Rectangle(30, 30, 601, 31));
			...
			ttc1Label.setBounds(new Rectangle(90, 120, 61, 16));
			ttc2Label.setBounds(new Rectangle(150, 120, 61, 16));
			ttc3Label.setBounds(new Rectangle(210, 120, 61, 16));
			ttc4Label.setBounds(new Rectangle(270, 120, 61, 16));
			ttc5Label.setBounds(new Rectangle(330, 120, 61, 16));
			ttc6Label.setBounds(new Rectangle(390, 120, 61, 16));
			ttc7Label.setBounds(new Rectangle(450, 120, 61, 16));



			ttcRefLabel = new JLabel();
			ttcRefLabel.setText("Reference");
			ttcRefLabel.setBounds(new Rectangle(30, 150, 61, 16));
			ttcRefLabel.setHorizontalAlignment(SwingConstants.LEFT);

			ttcMultimeterChannelLabel = new JLabel();
			ttcMultimeterChannelLabel.setBounds(new Rectangle(30, 180, 61, 16));
			ttcMultimeterChannelLabel.setText("Channel");
			ttcMultimeterChannelLabel.setHorizontalAlignment(SwingConstants.LEFT);
	...
	private JPanel getTemperatureStabilizationCriteriumDataPanel() {
		if (temperatureStabilizationCriteriumDataPanel == null) {
			...
			maxAdmissibleTempErrorLabel1 = new JLabel();
			maxAdmissibleTempErrorLabel1.setBounds(new Rectangle(390, 270, 151, 31));
			maxAdmissibleTempErrorLabel1.setHorizontalAlignment(SwingConstants.LEFT);
			maxAdmissibleTempErrorLabel1.setText("ºC");
			maxAdmissibleTempErrorLabel1.setDisplayedMnemonic(KeyEvent.VK_UNDEFINED);
			maxAdmissibleTempErrorLabel1.setForeground(Color.GRAY);
			maxAdmissibleTempErrorLabel1.setEnabled(false);
			...
			maxAdmissibleTempErrorLabel = new JLabel();
			maxAdmissibleTempErrorLabel.setBounds(new Rectangle(30, 270, 226, 31));
			maxAdmissibleTempErrorLabel.setHorizontalAlignment(SwingConstants.LEFT);
			maxAdmissibleTempErrorLabel.setDisplayedMnemonic(KeyEvent.VK_UNDEFINED);
			maxAdmissibleTempErrorLabel.setText("Max Admissible Temperature Error");
			maxAdmissibleTempErrorLabel.setForeground(Color.GRAY);
			maxAdmissibleTempErrorLabel.setEnabled(false);
			...
			temperatureStabiltizationTimejLabel.setBounds(new Rectangle(30, 330, 226, 31));
			...
			temperatureStabiltizationTimejLabel2.setBounds(new Rectangle(390, 330, 151, 31));
			...
			temperatureStabilizationCriteriumDataPanel.add(maxAdmissibleTempErrorLabel, null);
			...
			temperatureStabilizationCriteriumDataPanel.add(getMaximunAdmissibleTempErrorComboBox(), null);
			...
			temperatureStabilizationCriteriumDataPanel.add(maxAdmissibleTempErrorLabel1, null);
		}
	...
	private void loadTemperatureProfileProgramData(TTCSetUpData _thermalCalibrationData){
		...
		waitForGoodRoomTemperatureStabilizationjCheckBox.setSelectedForTest(_thermalCalibrationData.getTemperatureProfileData().isWaitForGoodRoomTemperatureStabilization());
		addTemperatureProfileItemListeners();
	}
	private void loadTTCsToCalibrateData(TTCSetUpData _thermalCalibrationData){

		this.ttc1CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[0].isSelected());
		this.ttc1RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[0].getDeviceReference());
		this.ttc1MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[0].getTTC_Channel());

		this.ttc2CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[1].isSelected());
		this.ttc2RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[1].getDeviceReference());
		this.ttc2MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[1].getTTC_Channel());

		this.ttc3CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[2].isSelected());
		this.ttc3RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[2].getDeviceReference());
		this.ttc3MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[2].getTTC_Channel());

		this.ttc4CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[3].isSelected());
		this.ttc4RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[3].getDeviceReference());
		this.ttc4MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[3].getTTC_Channel());

		this.ttc5CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[4].isSelected());
		this.ttc5RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[4].getDeviceReference());
		this.ttc5MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[4].getTTC_Channel());

		this.ttc6CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[5].isSelected());
		this.ttc6RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[5].getDeviceReference());
		this.ttc6MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[5].getTTC_Channel());

		this.ttc7CheckBox.setSelectedForTest(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[6].isSelected());
		this.ttc7RefTextField.setText(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[6].getDeviceReference());
		this.ttc7MultimeterChannelComboBox.setSelectedItem(_thermalCalibrationData.getTTCsToCalibrateData().getDevicesToCalibrate()[6].getTTC_Channel());

		}
	private void loadTemperatureStabilizationCriteriumData(TTCSetUpData _thermalCalibrationData){
		this.maxAdmissibleTempErrorComboBox.setSelectedItem(Double.toString(_thermalCalibrationData.getTemperatureStabilizationCriteriumData().getMaxAdminssibleTemperatureError()));
	...
	private void setDefaultTemperatureStabilizationCriteriumData(){
		maxAdmissibleTempErrorComboBox.setSelectedItem("2.0");
	...
	private void saveToXMLFile(String _programFilePath) throws Exception{
		  ...
		  TTC[] deviceToMeasureData = new TTC[N_TTCs_TO_MEASURE];
		  System.out.println("---------------------------> "+(Integer)ttc1MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[0] = new TTC(ttc1CheckBox.isSelected(),ttc1RefTextField.getText(),(Integer)ttc1MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[1] = new TTC(ttc2CheckBox.isSelected(),ttc2RefTextField.getText(),(Integer)ttc2MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[2] = new TTC(ttc3CheckBox.isSelected(),ttc3RefTextField.getText(),(Integer)ttc3MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[3] = new TTC(ttc4CheckBox.isSelected(),ttc4RefTextField.getText(),(Integer)ttc4MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[4] = new TTC(ttc5CheckBox.isSelected(),ttc5RefTextField.getText(),(Integer)ttc5MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[5] = new TTC(ttc6CheckBox.isSelected(),ttc6RefTextField.getText(),(Integer)ttc6MultimeterChannelComboBox.getSelectedItem());
		  deviceToMeasureData[6] = new TTC(ttc7CheckBox.isSelected(),ttc7RefTextField.getText(),(Integer)ttc7MultimeterChannelComboBox.getSelectedItem());


		  TTCsToCalibrate measuresConfigurationData = new TTCsToCalibrate
		  (
				deviceToMeasureData
		  );
	...
	private JCheckBox getTTC1CheckBox() {
		if (ttc1CheckBox == null) {
			...
			ttc1CheckBox.setBounds(new Rectangle(90, 90, 61, 16));
	...
	private JCheckBox getTTC2CheckBox() {
		if (ttc2CheckBox == null) {
			...
			ttc2CheckBox.setBounds(new Rectangle(150, 90, 61, 16));
	...
	private JCheckBox getTTC3CheckBox() {
		if (ttc3CheckBox == null) {
			...
			ttc3CheckBox.setBounds(new Rectangle(210, 90, 61, 16));
	...
	private JCheckBox getTTC4CheckBox() {
		if (ttc4CheckBox == null) {
			...
			ttc4CheckBox.setBounds(new Rectangle(270, 90, 61, 16));
	...
	private JCheckBox getTTC5CheckBox() {
		if (ttc5CheckBox == null) {
			...
			ttc5CheckBox.setBounds(new Rectangle(330, 90, 61, 16));
	...
	private JCheckBox getTTC6CheckBox() {
		if (ttc6CheckBox == null) {
			...
			ttc6CheckBox.setBounds(new Rectangle(390, 90, 61, 16));
	...
	private JCheckBox getTTC7CheckBox() {
		if (ttc7CheckBox == null) {
			...
			ttc7CheckBox.setBounds(new Rectangle(450, 90, 61, 17));
	...
	private JTextField getTTC1RefTextField() {
		if (ttc1RefTextField == null) {
			...
			ttc1RefTextField.setEnabled(true);
			ttc1RefTextField.setBounds(new Rectangle(90, 150, 61, 16));
		}
	...
	private JTextField getTTC2RefTextField() {
		if (ttc2RefTextField == null) {
			...
			ttc2RefTextField.setEnabled(false);
			ttc2RefTextField.setBounds(new Rectangle(150, 150, 61, 16));
		}
	...
	private JTextField getTTC3RefTextField() {
		if (ttc3RefTextField == null) {
			...
			ttc3RefTextField.setBounds(new Rectangle(210, 150, 61, 16));
			ttc3RefTextField.setEnabled(false);
		}
	...
	private JTextField getTTC4RefTextField() {
		if (ttc4RefTextField == null) {
			...
			ttc4RefTextField.setBounds(new Rectangle(270, 150, 61, 16));
			ttc4RefTextField.setEnabled(false);
		}
	...
	private JTextField getTTC5RefTextField() {
		if (ttc5RefTextField == null) {
			...
			ttc5RefTextField.setEnabled(false);
			ttc5RefTextField.setBounds(new Rectangle(330, 150, 61, 16));
		}
	...
	private JTextField getTTC6RefTextField() {
		if (ttc6RefTextField == null) {
			...
			ttc6RefTextField.setBounds(new Rectangle(390, 150, 61, 16));
			ttc6RefTextField.setEnabled(false);
		}
	...
	private JTextField getTTC7RefTextField() {
		if (ttc7RefTextField == null) {
			...
			ttc7RefTextField.setBounds(new Rectangle(450, 150, 61, 16));
			ttc7RefTextField.setEnabled(false);
		}
	...
	private JComboBox getTTC1MultimeterChannelComboBox() throws Exception{
		if (ttc1MultimeterChannelComboBox == null) {
			...
			ttc1MultimeterChannelComboBox.setEnabled(false);
			ttc1MultimeterChannelComboBox.setBounds(new Rectangle(90, 180, 61, 16));
	...
	private JComboBox getTTC2MultimeterChannelComboBox() {
		if (ttc2MultimeterChannelComboBox == null) {
			...
			ttc2MultimeterChannelComboBox.setEnabled(false);
			ttc2MultimeterChannelComboBox.setBounds(new Rectangle(150, 180, 61, 16));
			for (int i=0;i<=N_MULTIMETER_CHANNELS;i++){
	...
	private JComboBox getTTC3MultimeterChannelComboBox() {
		if (ttc3MultimeterChannelComboBox == null) {
			...
			ttc3MultimeterChannelComboBox.setEnabled(false);
			ttc3MultimeterChannelComboBox.setBounds(new Rectangle(210, 180, 61, 16));
			for (int i=0;i<=N_MULTIMETER_CHANNELS;i++){
	...
	private JComboBox getTTC4MultimeterChannelComboBox() {
		if (ttc4MultimeterChannelComboBox == null) {
			...
			ttc4MultimeterChannelComboBox.setEnabled(false);
			ttc4MultimeterChannelComboBox.setBounds(new Rectangle(270, 180, 61, 16));
			for (int i=0;i<=N_MULTIMETER_CHANNELS;i++){
	...
	private JComboBox getTTC5MultimeterChannelComboBox() {
		if (ttc5MultimeterChannelComboBox == null) {
			...
			ttc5MultimeterChannelComboBox.setEnabled(false);
			ttc5MultimeterChannelComboBox.setBounds(new Rectangle(330, 180, 61, 16));
			for (int i=0;i<=N_MULTIMETER_CHANNELS;i++){
	...
	private JComboBox getTTC6MultimeterChannelComboBox() {
		if (ttc6MultimeterChannelComboBox == null) {
			...
			ttc6MultimeterChannelComboBox.setEnabled(false);
			ttc6MultimeterChannelComboBox.setBounds(new Rectangle(390, 180, 61, 16));
			for (int i=0;i<=N_MULTIMETER_CHANNELS;i++){
	...
	private JComboBox getTTC7MultimeterChannelComboBox() {
		if (ttc7MultimeterChannelComboBox == null) {
			...
			ttc7MultimeterChannelComboBox.setEnabled(false);
			ttc7MultimeterChannelComboBox.setBounds(new Rectangle(450, 180, 61, 16));
			for (int i=0;i<=N_MULTIMETER_CHANNELS;i++){
	 ...
	 * @return javax.swing.JComboBox
	 */
	private JComboBox getMaximunAdmissibleTempErrorComboBox() {
		if (maxAdmissibleTempErrorComboBox == null) {
			maxAdmissibleTempErrorComboBox = new JComboBox();
			maxAdmissibleTempErrorComboBox.setBounds(new Rectangle(270, 270, 106, 31));
			for (double i=1;i<=500;i=i+1){
				maxAdmissibleTempErrorComboBox.addItem (Double.toString(i/100));
			}
		}
		maxAdmissibleTempErrorComboBox.setForeground(Color.GRAY);
		maxAdmissibleTempErrorComboBox.setEnabled(false);
		return maxAdmissibleTempErrorComboBox;
	}
	/**
	 * This method initializes standardDeviationComboBox
	 *
			...
			temperatureStabilitzationByStDevjRadioButtonItemListener = new ItemListener()
		    {
		        public void itemStateChanged(ItemEvent e)
		        {
		        	if (e.getStateChange()==ItemEvent.SELECTED){
		        		...
		        		maxAdmissibleTempErrorComboBox.setForeground(Color.BLACK);
			...
			temperatureStabilitzationByTimejRadioButtonItemListener = new ItemListener()
		    {
		        public void itemStateChanged(ItemEvent e)
		        {
		        	if (e.getStateChange()==ItemEvent.SELECTED){
		        		...
		        		maxAdmissibleTempErrorComboBox.setForeground(Color.LIGHT_GRAY);
	...
	private JComboBox getTemperatureStabilitzationTimejComboBox() {
		if (temperatureStabilitzationTimeComboBox == null) {
			...
			temperatureStabilitzationTimeComboBox.setBounds(new Rectangle(270, 330, 106, 31));
	...
	private JTextField getWarningTextField() {
		if (warningTextField == null) {
			...
			warningTextField.setBounds(new Rectangle(30, 225, 481, 61));
	...
	/**
	 * This method initializes measureDevicesAtRoomTemperaturejCheckBox
	 *
	 * @return javax.swing.JCheckBox
	 */
	private JCheckBox getWaitForGoodRoomTemperatureStabilizationjCheckBox() {
		if (waitForGoodRoomTemperatureStabilizationjCheckBox == null) {
			...
			waitForGoodRoomTemperatureStabilizationjCheckBox.setBounds(new Rectangle(25, 400, 283, 21));
