...
public class TTCalibrationProgressScreenFrame extends JFrame{
	...
	private JTabbedPane getLogResultsTableAndGraphTabbedPane() {
		if (logResultsTableAndGraphTabbedPane == null) {
			...
			logResultsTableAndGraphTabbedPane.addTab(getOvenTemperatureEvolutionGraphPanel().getName(), null, getOvenTemperatureEvolutionGraphPanel(), null);
		}
	 ...
	 * @return javax.swing.JPanel
	 */
	private JPanel getOvenTemperatureEvolutionGraphPanel() {
		if (graphPanel == null) {
