...
public class InstrumentsComunicationsAndTemperatureSensorConfigFrame extends JFrame implements ActionListener{
...
/**
	 ...
	 */
	public InstrumentsComunicationsAndTemperatureSensorConfigFrame(String _instrumentsDataFilePath,String _temperatureSensorDataFilePath,MainController _mainController)throws Exception {
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				InstrumentsComunicationsAndTemperatureSensorConfigFrame thisClass;
				try {
					thisClass = new InstrumentsComunicationsAndTemperatureSensorConfigFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,null);
