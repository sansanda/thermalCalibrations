...
import fileUtilities.XMLFileFilter;
import frontController.*;
import gui.TTCCalibrationViewerFrame;

public class ViewExistingCalibrationProgramAction implements ActionInterface{
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
    		...
    		ttcProgramViewer = new TTCCalibrationViewerFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,ttcSetUpFilePath,_program,VIEW_MODE,mainController);
