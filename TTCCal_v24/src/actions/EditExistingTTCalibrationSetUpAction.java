...
public class EditExistingTTCalibrationSetUpAction implements ActionInterface{
	...
	public boolean execute(ActionRequest _req) throws IOException, Exception
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
    		...
    		ttcProgramViewer = new TTCCalibrationViewerFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,ttcSetUpFilePath,_program,EDIT_MODE,mainController);
