...
import device.TTC;
import devicesToCalibrate.TTCsToCalibrate;


public class TTCSetUpData {

	private TemperatureProfileData 					temperatureProfileData;
	private TTCsToCalibrate 					ttcsToCalibrateData;
	...
	public TTCSetUpData(
			...
			TTCsToCalibrate _ttcsToCalibrateData,
	...
	public TTCsToCalibrate getTTCsToCalibrateData(){
	...
	public void initializeFromXMLFile(String _filePath)throws Exception{
		...
		ttcsToCalibrateData = new TTCsToCalibrate(thermalCalibrationProgramElementRoot.getChild("TTCsToCalibrateData"));
	...
	public static void main(String[] args) throws Exception{
		...
		TTC[] ttcToCalibrateData = new TTC[7];
		for (int i=0;i<7;i++){
			ttcToCalibrateData[i] = new TTC(true,Integer.toString(i+1),i+2);
		}
		TTCsToCalibrate ttcsToCalibrateData = new TTCsToCalibrate(ttcToCalibrateData);
