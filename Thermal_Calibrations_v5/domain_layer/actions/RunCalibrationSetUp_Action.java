...
public class RunCalibrationSetUp_Action implements Action{
		...
		runProgramSwingWorker = new SwingWorker() {
			public Object construct() {
				try {
					...
					if (setTheActualCalibrationSetUpStepAboveTheMeasuredRoomTemperature(calibrationSetUp)==-1) return null;
	...
	private int setTheActualCalibrationSetUpStepAboveTheMeasuredRoomTemperature(CalibrationSetUp _program)throws Throwable
	{
