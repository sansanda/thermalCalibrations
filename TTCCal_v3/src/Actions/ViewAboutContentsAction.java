...
public class ViewAboutContentsAction implements Action{
	...
	{
		aboutContentsFrame = new AboutContentsFrame();
		aboutContentsFrame.addWindowListener(main);
		aboutContentsFrame.setSize(new Dimension(1000, 800));
