...
public class RunCalibrationSetUp_Action extends AbstractAction{
	...
	public RunCalibrationSetUp_Action()throws Exception{
		AbstractAction.printAction("Setting the Security Manager to null");
		System.setSecurityManager(null);
		AbstractAction.printAction("Creando instancias para manejar fechas y horas");
		result=null;
		mainController=null;
	}
	...
	private int initializeCalibrationSetUp()throws Exception{
		AbstractAction.printAction("Initializing Program");
		AbstractAction.printAction("Creando la instancia para el selector de ficheros");
		AbstractAction.printAction("Solicitamos los ficheros para ejecutar el programa y guardar los resultados.");
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            AbstractAction.printAction("Creando la instancia para el programa.");
	...
	private int initializeResultsFile(File _resultsFile)throws Exception{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            //This is where a real application would open the file.
            //log.append("Opening: " + file.getName() + "." + newline);
			AbstractAction.printAction("Inicializando el fichero de salida de resultados....");
	...
	private void printActionMessageAndProgressScreenMessage(String _msg){
		AbstractAction.printAction(_msg);
