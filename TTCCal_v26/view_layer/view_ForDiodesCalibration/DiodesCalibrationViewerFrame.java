...
public class DiodesCalibrationViewerFrame extends JFrame implements ActionListener{
	 ...
	 */
	public DiodesCalibrationViewerFrame(String _instrumentsDataFilePath,String _temperatureSensorDataFilePath,String _ttcSetUpFilePath,DiodesCalibrationSetUpData _program,int _mode, MainController _mainController) throws Exception{
	...
	private void initialize(
			...
			int _mode) throws Exception
			{
				...
				createPanelsAndAddToJTabbedPane();
	...
	private void createPanelsAndAddToJTabbedPane() throws Exception {
		...
		ttc_SetUp_Description_JPanel = new Thermal_Calibration_SetUp_Description_JPanel("SetUP Description",program.getDiodesCalibrationSetUpDescriptionData().getProgramName(),program.getDiodesCalibrationSetUpDescriptionData().getProgramAuthor(),program.getDiodesCalibrationSetUpDescriptionData().getProgramDescription());
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
					try {
						...
						String programFilePath = "c:\\p1_diodes.xml";
						...
						DiodesCalibrationViewerFrame thisClass = new DiodesCalibrationViewerFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,programFilePath,_program,1,null);
