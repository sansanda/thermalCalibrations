...
public class TTCsCalibration_MainScreenFrame extends JFrame implements ActionListener{

	private static int RUN_PROGRAM_MODE = 1;
	private static int STOP_PROGRAM_MODE = 0;

	private static final long serialVersionUID = 1L;
	private TTC_Calibration_MainController mainController = null;
	 ...
	 */
	public TTCsCalibration_MainScreenFrame(MainController _mainController) {
		super();
		mainController = (TTC_Calibration_MainController)_mainController;
