...
public class CreateNewDiodesCalibrationSetUp_Action implements Action{
	...
	{
		int newMode = 0;
		diodesCalibrationSetUpViewer = new DiodesCalibrationViewerFrame(instrumentsDataFilePath,temperatureSensorDataFilePath,diodesCalibrationSetUpFilePath,null,newMode,mainController);
